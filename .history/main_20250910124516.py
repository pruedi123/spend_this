...
try:
    ...
    grand_rows = [
        {
            "Portfolio": "Global",
            "Years": years_int,
            "Annual — Lump Sum": annual_lump_g,
            "Annual — Habits Total": habits_total_g,
            "Annual — Grand Total": annual_lump_g + habits_total_g,
        ...
        },
        {
            "Portfolio": "SPX",
            "Years": years_int,
            "Annual — Lump Sum": annual_lump_s,
            "Annual — Habits Total": habits_total_s,
            "Annual — Grand Total": annual_lump_s + habits_total_s,
    ...
    for col in [
        "Annual — Lump Sum", "Annual — Habits Total", "Annual — Grand Total",
