...
global_best_min = float(np.nanmax(raw_df["Global Minimum Ending Value"].values)) if not raw_df.empty else np.nan
global_best_med = float(np.nanmax(raw_df["Global Median Ending Value"].values)) if not raw_df.empty else np.nan
spx_best_min    = float(np.nanmax(raw_df["SPX Mininimum Ending Value"].values)) if not raw_df.empty else np.nan
spx_best_med    = float(np.nanmax(raw_df["SPX Median Ending Value"].values)) if not raw_df.empty else np.nan
