...
if median_withdrawal_g is not None:
    ...
    _msg_g = (
        ...
        f"and spending (${whatif_spend:,.0f}), you cost yourself <strong>${total_income_g:,.0f}</strong> in lifetime retirement income."
    )
...
if median_withdrawal_s is not None:
    ...
    _msg_s = (
        f"By spending what you wanted (${thinking_spend:,.0f}) instead of being a bit more frugal "
        f"and spending (${whatif_spend:,.0f}), you cost yourself <strong>${total_income_s:,.0f}</strong> in total lifetime retirement income."
    )
