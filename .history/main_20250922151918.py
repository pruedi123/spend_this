        ...
        if section_toggle(f"Annual Habit {idx} — Min & Median by Allocation"):
            ...
            def _style_max(_):
                ...
                try:
                    ...
                    pass
                return styles
            st.dataframe(result_annual_df.style.apply(_style_max, axis=None), width='stretch')
            # st.download_button(
...
if int(years) > 0:
    ...
    if has_auto:
        ...
        if section_toggle("Auto — Year-by-Year Payment Difference"):
            ...
            st.dataframe(auto_sched_disp, width='stretch')
    ...
    if has_housing:
        ...
        st.dataframe(house_sched_disp, width='stretch')
    ...
    if has_habits:
        ...
        if section_toggle("Annual Habits — Year-by-Year Contributions"):
            ...
            st.dataframe(habits_sched_disp, width='stretch')
        ...
        if has_auto or has_habits:
            ...
            if section_toggle("Combined — Year-by-Year Contributions"):
                ...
                st.dataframe(combined_disp, width='stretch')
            ...
            try:
                ...
                if sims_a.empty:
                    ...
                    try:
                        ...
                        st.dataframe(sel_stats_disp, width='stretch')
...
if years > 0 and has_housing:
    ...
    if section_toggle("Housing Payments Invested — Min & Median by Allocation"):
        ...
        st.dataframe(result_house_df, width='stretch')
...
if has_lump and not raw_df.empty:
    ...
    if has_lump and not raw_df.empty and lump_rows:
        ...
        if section_toggle("Median Withdrawal — Lump Sum"):
            ...
            st.dataframe(lump_disp, width='stretch')
...
for idx, raw_rows_annual in enumerate(raw_rows_annual_list, start=1):
    ...
    if annual_rows:
        ...
        if section_toggle(f"Median Withdrawal — Annual Habit {idx} Only"):
            ...
            st.dataframe(annual_disp, width='stretch')
...
if 'raw_auto_df' in locals() and isinstance(raw_auto_df, pd.DataFrame) and not raw_auto_df.empty:
    ...
    if auto_rows:
        ...
        st.dataframe(auto_med_disp, width='stretch')
...
if 'raw_house_df' in locals() and isinstance(raw_house_df, pd.DataFrame) and not raw_house_df.empty:
    ...
    if housing_rows:
        ...
        st.dataframe(housing_disp, width='stretch')
...
try:
    ...
    if section_toggle("Grand Total — Ending Values (Min & Median) across Streams"):
        ...
        st.dataframe(ev_disp, width='stretch')
    # st.download_button(
